...
public class CuisineFuserFavourSource extends AttributeValueFuser<List<Cuisine>, Restaurant, Attribute> {

    public CuisineFuserFavourSource() {
        super(new FavourSources<List<Cuisine>, Restaurant, Attribute>());
    }
