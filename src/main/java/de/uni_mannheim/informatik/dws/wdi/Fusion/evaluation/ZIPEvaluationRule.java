...
public class ZIPEvaluationRule extends EvaluationRule<Restaurant, Attribute> {
	...
	public boolean isEqual(Restaurant record1, Restaurant record2, Attribute schemaElement) {
		...
		// matter
		return sim.calculate(Integer.toString(record1.getZip()), Integer.toString(record2.getZip())) == 1.0;
	}
