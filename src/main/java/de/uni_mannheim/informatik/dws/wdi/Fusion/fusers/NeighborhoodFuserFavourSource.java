...
public class NeighborhoodFuserFavourSource extends AttributeValueFuser<List<Neighborhood>, Restaurant, Attribute> {

    public NeighborhoodFuserFavourSource() {
        super(new FavourSources<List<Neighborhood>, Restaurant, Attribute>());
    }
